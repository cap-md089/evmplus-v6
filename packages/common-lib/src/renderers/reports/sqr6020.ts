				...
				table: {
					...
					body: [
						...
						[
							...
							},
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'MALE' && hfzentry.Age === 10) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'MALE' && hfzentry.Age === 11) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'MALE' && hfzentry.Age === 12) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'MALE' && hfzentry.Age === 13) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'MALE' && hfzentry.Age === 14) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'MALE' && hfzentry.Age === 15) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'MALE' && hfzentry.Age === 16) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'MALE' && hfzentry.Age === 17) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'MALE' && hfzentry.Age === 18) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
				...
				table: {
					...
					body: [
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'FEMALE' && hfzentry.Age === 10) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'FEMALE' && hfzentry.Age === 11) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'FEMALE' && hfzentry.Age === 12) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'FEMALE' && hfzentry.Age === 13) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'FEMALE' && hfzentry.Age === 14) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'FEMALE' && hfzentry.Age === 15) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'FEMALE' && hfzentry.Age === 16) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'FEMALE' && hfzentry.Age === 17) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
						...
						[
							...
							{
								text: CadetHFZRequirementsMap.find(function (hfzentry) {
									if (hfzentry.Gender === 'FEMALE' && hfzentry.Age === 18) {
										return true;
									}
								})?.Pacer,
								fontSize: mySmallFontSize,
