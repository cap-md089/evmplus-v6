...
export const sqr601XL = (): Array<Array<string | number>> => {
	let row: Array<string | number> = ['Event Manager Cadet Status Report SQR 60-1'];
...
export const Formatsqr601XL = (sheet: XLSX.Sheet): XLSX.Sheet => {
...
export const Formatsqr601MembersXL = (
	sheet: XLSX.Sheet,
