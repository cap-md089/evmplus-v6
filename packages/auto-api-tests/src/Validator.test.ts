...
const requiredGenericTypeValidator = validator<Required<GenericType<number>>>(
  Validator
);
const optionalGenericTypeValidator = validator<Partial<GenericType<number>>>(
  Validator
);
...
const genericTypeBasicTypeValidator = validator<GenericType<BasicType>>(
  Validator
);
const intersectValidator = validator<TypeIntersect>(Validator);
const genericIntersectValidator = validator<GenericIntersect<number>>(
  Validator
);
...
describe("Validator", () => {
  ...
  it("should operate on complex types", () => {
    expect(
      complexValidator.validate({ basicThing: { thing: "string" } }, "")
    ).toBeRight();
    expect(
      complexValidator.validate({ basicThing: { thing: 1 } }, "")
    ).toBeLeft();
    expect(
      complexValidator.validate({ basicThing: { otherThing: 1 } }, "")
    ).toBeLeft();
    ...
    expect(
      complexArrayValidator.validate(
        { things: [{ thing: "string" }, { thing: 1 }] },
        ""
      )
    ).toBeLeft();
    expect(
      complexArrayValidator.validate(
        { things: [{ thing: "string" }, null] },
        ""
      )
    ).toBeLeft();
    expect(
      complexArrayValidator.validate(
        { things: [{ thing: "string" }, undefined] },
        ""
      )
    ).toBeLeft();
  });
  ...
  it("should prune basic types", () => {
    expect(
      basicValidator.validate(
        { thing: "string", otherThing: "anotherstring" },
        ""
      )
    ).toEqualRight({
      thing: "string"
  ...
  it("should validate complex unions", () => {
    ...
    expect(
      maybeValidator.validate({ hasValue: true, value: 0 }, "")
    ).toEqualRight({
      hasValue: true,
      value: 0
    });
  ...
  it("should validate complex intersections", () => {
    ...
    expect(
      intersectValidator.validate({ basicThing: { thing: "string" } }, "")
    ).toBeLeft();
  ...
  it("should validate interface extension", () => {
    expect(
      extendsOtherValidator.validate({ thing: "string", otherThing: 1 }, "")
    ).toBeRight();
    expect(
      extendsOtherValidator.validate({ thing: 1, otherThing: "string" }, "")
    ).toBeLeft();
  ...
  it("should validate Required/Partial", () => {
    ...
    expect(
      requiredTypeValidator.validate({ thing: "string" }, "")
    ).toMatchRight({
      thing: "string"
    });
    ...
    expect(
      requiredGenericTypeValidator.validate(
        { otherThing: "string", thing: 0 },
        ""
      )
    ).toEqualRight({
      otherThing: "string",
    ...
    expect(
      requiredGenericTypeValidator.validate({ otherThing: null }, "")
    ).toBeLeft();

    expect(optionalGenericTypeValidator.validate({}, "")).toBeRight();
    expect(
      optionalGenericTypeValidator.validate(
        { otherThing: "string", thing: 0 },
        ""
      )
    ).toEqualRight({
    ...
    expect(
      optionalGenericTypeValidator.validate({ otherThing: null }, "")
    ).toBeLeft();
    expect(
      optionalGenericTypeValidator.validate(
        { otherThing: "string", eh: "string" },
        ""
      )
    ).toEqualRight({ otherThing: "string" });
    expect(
      optionalGenericTypeValidator.validate({ thing: 0, eh: "string" }, "")
    ).toEqualRight({
      thing: 0
    });
  });
  ...
  it("should validate generic types", () => {
    expect(
      genericTypeNumberValidator.validate(
        { thing: 0, otherThing: "string" },
        ""
      )
    ).toEqualRight({ thing: 0, otherThing: "string" });
    expect(
      genericTypeNumberValidator.validate({ thing: "string" }, "")
    ).toBeLeft();
    expect(genericTypeNumberValidator.validate({}, "")).toBeLeft();

    expect(
      genericTypeStringValidator.validate(
        { thing: "string", otherThing: "string" },
        ""
      )
    ...
    expect(
      genericArrayValidator.validate(
        [{ otherThing: "string", thing: "string" }],
        ""
      )
    ).toBeRight();
    expect(
      genericArrayValidator.validate([{ otherThing: "string", thing: 0 }], "")
    ).toBeLeft();
    expect(
      genericArrayValidator2.validate(
        [{ otherThing: "string", thing: "string" }],
        ""
      )
    ).toBeRight();
  ...
  describe("built in validator functions", () => {
    ...
    describe("Arrays", () => {
      ...
      it("should validate arrays of validators", () => {
        ...
        expect(
          arrayValidator2.validate(["string", "string 2"], "")
        ).toBeRight();
        ...
        expect(
          arrayValidator3.validate(["string", "string 2"], "")
        ).toBeRight();
    ...
    describe("union types", () => {
      ...
      it("should validate union types", () => {
        ...
        expect(
          or2.validate({ basicThing: { thing: "string " } }, "")
        ).toBeRight();
