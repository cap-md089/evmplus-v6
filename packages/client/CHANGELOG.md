...
# [1.25.0](https://github.com/cap-md089/evmplus-v6/compare/client@1.17.0...client@1.25.0) (2021-01-03)


### Bug Fixes

* fixed merge pains ([cdba40d](https://github.com/cap-md089/evmplus-v6/commit/cdba40d4fbdea24785683e52ad4c907472b43945))
* fixed the security and performance of debrief viewer ([22cc9ee](https://github.com/cap-md089/evmplus-v6/commit/22cc9eec34b28a5aecb38789164a7b0006bfe7e9))
* **client:** added privacy policy and terms and conditions from v4 ([21ad932](https://github.com/cap-md089/evmplus-v6/commit/21ad93261fa4b59f8813b5c5506269fe168586f9))
* **client:** disabling private attendance for now ([9b92d5e](https://github.com/cap-md089/evmplus-v6/commit/9b92d5ea9fff91ac521790fe71990c139a7a329e))
* **client:** fixed compile warnings from version upgrade ([3699ae5](https://github.com/cap-md089/evmplus-v6/commit/3699ae52ecd71326ba386637e1dee9cfac9a38a3))
* **client:** fixed error messages appearing after CAP ID is entered ([3340104](https://github.com/cap-md089/evmplus-v6/commit/3340104615e5c955d4ced803179d94b69f554c4c))
* **client:** fixed scan add providing cryptic error messages ([f40fafc](https://github.com/cap-md089/evmplus-v6/commit/f40fafcdc6a5303e16e4fd645e3879029ad7a9d6)), closes [#63](https://github.com/cap-md089/evmplus-v6/issues/63)
* **client:** fixed styles and polyfills to make site work on MS Edge 18 ([2b77c11](https://github.com/cap-md089/evmplus-v6/commit/2b77c11d2cd6030a55f31830b3eabf76ef1f2af6)), closes [#89](https://github.com/cap-md089/evmplus-v6/issues/89)
* **client:** prevented past attendance record information from being changed by non-manager members ([7133234](https://github.com/cap-md089/evmplus-v6/commit/713323430368bded1993ad5a71dee4067cc79d55)), closes [#99](https://github.com/cap-md089/evmplus-v6/issues/99)
* **client:** removed a reference to a file in a different branch ([f1a95df](https://github.com/cap-md089/evmplus-v6/commit/f1a95df461cd63a26840be444a10f048c077fc3d))
...
* added error catching to the event link list ([25828cc](https://github.com/cap-md089/evmplus-v6/commit/25828ccdfcca0bb5f1c82222f1ad09531d5231c9))
...
* fixed eventform crashing trying to render interal POCs ([86b5806](https://github.com/cap-md089/evmplus-v6/commit/86b5806f841ec04356d26e02b451bf00515e3776))
...
* prepared eventform for wing demonstration ([7a899ad](https://github.com/cap-md089/evmplus-v6/commit/7a899adfe47e96a818b80ca323962765df748751))


### Features

* **attendance:** added date filter to attendance history page ([412a58c](https://github.com/cap-md089/evmplus-v6/commit/412a58c0398bf29730209a5aec14af1bcfa4d392)), closes [#21](https://github.com/cap-md089/evmplus-v6/issues/21)
...
* **event link list:** added popup selection to change event status directly from link list page ([5e68eae](https://github.com/cap-md089/evmplus-v6/commit/5e68eae9bf2fe58ec762b5fa6ec45f1e20d861ed)), closes [#14](https://github.com/cap-md089/evmplus-v6/issues/14)
...
* **eventviewer:** added color coding to event status text based on event status value ([90ca6d5](https://github.com/cap-md089/evmplus-v6/commit/90ca6d5adfce53295de000bbdec78b41099b727a))
* **eventviewer:** disabled linked event code ([3ee1b58](https://github.com/cap-md089/evmplus-v6/commit/3ee1b58cb430d98597da31fbf3c8c477b0542b26))
* **eventviewer:** fixed display glitch regarding attendance links ([09ed0a2](https://github.com/cap-md089/evmplus-v6/commit/09ed0a2252fcd62ff8f45f2b9cc28cd0d7652222))
...
* fixed formatting on EventViewer ([4c442ec](https://github.com/cap-md089/evmplus-v6/commit/4c442ec35ae7dd68a3971658ba925277f09023b1))
...
* **client:** minor changes to keys used and display for scan add ([ea51dce](https://github.com/cap-md089/evmplus-v6/commit/ea51dce1dd44cd14126156962cd6f201362eff22))
