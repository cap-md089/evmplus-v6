...
export const PrivacyPolicy = () => (
	<div style={lineHeight}>
		...
		<br />
		<p>
			It is CAPUnit.com's policy to respect your privacy regarding any information we may
			collect while operating our website. This Privacy Policy applies to CAPUnit.com
			(hereinafter, "us", "we", or "CAPUnit.com"). We respect your privacy and are committed
		...
		<p>
			Like most website operators, CAPUnit.com may collect non-personally-identifying
			information of the sort that web browsers and servers typically make available, such as
			the browser type and the date and time of each visitor request. CAPUnit.com's purpose in
			collecting non-personally identifying information is to better understand how
			CAPUnit.com's visitors use its website. From time to time, CAPUnit.com may release
			non-personally-identifying information in the aggregate, e.g., by publishing a report on
			trends in the usage of its website.
		</p>
		<p>
			CAPUnit.com may also collect potentially personally-identifying information like CAPID
			and Internet Protocol (IP) addresses for logged in users. CAPUnit.com only discloses
		...
		<p>
			Certain visitors to CAPUnit.com's websites choose to interact with CAPUnit.com in ways
			that require CAPUnit.com to gather personally-identifying information. The amount and
			type of information that CAPUnit.com gathers depends on the nature of the interaction.
		...
		<p>
			CAPUnit.com discloses potentially personally-identifying and personally-identifying
			...
			disclose it to others except in the performance of CAP missions. CAPUnit.com will not
			...
			or when CAPUnit.com believes in good faith that disclosure is reasonably necessary to
			protect the property or rights of CAPUnit.com, third parties or the public at large.
		</p>
		<p>
			If you are a registered user of CAPUnit.com, we may occasionally send you an email to
			tell you about new features, solicit your feedback, or just keep you up to date with
			what's going on with CAPUnit.com and our services. We expect to keep this type of email
			...
			or respond to your request or to help us support other users. CAPUnit.com takes all
		...
		<p>
			CAPUnit.com may collect statistics about the behavior of visitors to its website.
			CAPUnit.com may display this information publicly or provide it to others. However,
			CAPUnit.com does not disclose your personally-identifying information.
		</p>
		<h2>Cookies</h2>
		<p>
			To enrich and perfect your online experience, CAPUnit.com uses "Cookies", similar
		...
		<p>
			...
			CAPUnit.com may use cookies to help CAPUnit.com identify and track visitors, their usage
			of the site, and their website access preferences. CAPUnit.com visitors who do not wish
			to have cookies placed on their computers should set their browsers to refuse cookies
			before using CAPUnit.com's websites, with the drawback that certain features of
			CAPUnit.com's websites may not function properly without the aid of cookies.
		</p>
		<p>
			By continuing to navigate our website without changing your cookie settings, you hereby
			acknowledge and agree to CAPUnit.com's use of cookies.
		</p>
		<h2>Privacy Policy Changes</h2>
		<p>
			Although most changes are likely to be minor, CAPUnit.com may change its Privacy Policy
			from time to time, and in CAPUnit.com's sole discretion. CAPUnit.com encourages visitors
