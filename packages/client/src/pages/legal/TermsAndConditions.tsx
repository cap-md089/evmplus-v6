...
export const TermsAndConditions = () => (
	<div style={lineHeight}>
		...
		<p>
			...
			terms refer to the process of our assistance to the Client in the most appropriate
			manner, whether by formal meetings of a fixed duration, or any other means, for the
			express purpose of meeting the Client's needs in respect of provision of the Company's
			stated services/products, in accordance with and subject to, prevailing law of Maryland.
		...
		<ol>
			<li>
				...
				<ol>
					<li>Civil Air Patrol organizations;</li>
		...
		<ol start={2}>
			...
			<li>
				...
				<ol>
					...
					<li>dot.com community sites; and</li>
		...
		<p>
			...
			link would not reflect unfavorably on us or our mission (for example, trade associations
			or other organizations representing inherently suspect types of business, such as
			work-at-home opportunities, shall not be allowed to link); (b)the organization does not
			have an unsatisfactory record with us; (c) the benefit to us from the visibility
			associated with the hyperlink outweighs the absence of the link; and (d) where the link
			is in the context of general resource information or is otherwise consistent with
