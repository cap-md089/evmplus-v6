 ...
 */
function getRandomNumber(upto: number) {
 ...
 */
function getRandomEnum<T>(value: any) {
	return (): T => {
		return (getRandomNumber(Object.entries(value).length / 2) as unknown) as T;
	};
}
...
const getRandomActivityAttendance = (): ActivityAttendance =>
	getRandomBoolean()
		...
		: { type: 'NONE' };
const getActivityAttendanceString = (attendance: ActivityAttendance) =>
