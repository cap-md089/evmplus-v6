...
describe('Validator', () => {
	...
	it('should validate complex unions', () => {
		expect(maybeValidator.validate({ hasValue: false }, '')).toEqualRight({ hasValue: false });
	...
	it('should validate complex intersections', () => {
		expect(
			intersectValidator.validate(
				{ thing: 'string', basicThing: { thing: 'string' }, otherThing: 'string' },
				''
			)
		).toEqualRight({ thing: 'string', basicThing: { thing: 'string' }, otherThing: 'string' });
		...
		).toEqualRight({ thing: 0, basicThing: { thing: 'string' }, otherThing: 'string' });
		expect(
