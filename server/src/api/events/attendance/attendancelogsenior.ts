...
export default asyncErrorHandler(async (req: AccountRequest<{ id: string }>, res: Response) => {
	...
	for (let i = 0; i < memberInformation.length; i++) {
		...
		memberInformation[i][0].borderColor =
			[ memberInformation[i][0].fillColor, memberInformation[i][0].fillColor,
		...
		memberInformation[i][3].borderColor = 
			memberInformation[i][3].bold 
				...
				: [
					memberInformation[i][3].fillColor, memberInformation[i][3].fillColor,
	...
	memberInformation[memberInformation.length-1][0].borderColor = 
			[ memberInformation[memberInformation.length-1][0].fillColor, 
				memberInformation[memberInformation.length-1][0].fillColor,
				memberInformation[memberInformation.length-1][0].fillColor, 'white' ];
	...
	memberInformation[memberInformation.length-1][2].borderColor = 
			[ memberInformation[memberInformation.length-1][0].fillColor, 
				...
				? 'black' : memberInformation[memberInformation.length-1][0].fillColor, 'white' ];
	...
	const formattedMemberInformation = [
		[
			...
			{ text: 'Signature', bold: true, fontSize: 10, borderColor: ['white', 'white','white'] }
		],
		...memberInformation
	];
